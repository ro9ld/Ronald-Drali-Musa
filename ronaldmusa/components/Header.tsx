...
export default function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-40 mx-auto flex h-12 max-w-[1200px] items-center justify-between px-4 transition-[background-color,backdrop-filter] duration-200 ease-out sm:h-14 sm:px-10 lg:max-w-[1440px] lg:px-16 xl:max-w-[1680px] xl:px-24 ${
