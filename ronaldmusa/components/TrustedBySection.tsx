...
export default function TrustedBySection() {
  ...
  return (
    <section className="pt-[38px] sm:pt-[52px]">
      <div className="partners-label px-4 text-[18px] sm:px-10 sm:text-[21px] lg:px-16 xl:px-24" style={{ margin: "0 0 20px" }}>
        <PartnersIcon />
      ...
      <div
        className={
          useScroll
            ? "no-scrollbar flex gap-8 overflow-x-auto px-4 pb-1 sm:px-10 sm:gap-14 lg:px-16 xl:px-24"
            : "grid grid-cols-2 items-center justify-items-center gap-x-5 gap-y-7 px-4 sm:flex sm:flex-wrap sm:justify-start sm:gap-14 sm:px-10 lg:px-16 xl:px-24"
        }
      >
        {sorted.map((p) => {
