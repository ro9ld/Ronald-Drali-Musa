...
export default function WorkSection() {
  ...
  return (
    <>
      <div className="section-label px-4 text-[13.5px] sm:px-10 lg:px-16 xl:px-24" style={{ margin: "28px 0 10px" }}>
        <WorkIcon />
        <span>Work</span>
      </div>

      <div className="flex gap-2 px-4 pb-3 sm:px-10 lg:px-16 xl:px-24">
        <button
      ...
      <section className="px-4 sm:px-10 lg:px-16 xl:px-24">
